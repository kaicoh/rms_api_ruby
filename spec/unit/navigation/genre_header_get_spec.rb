...
RSpec.describe RmsApiRuby::Navigation::GenreHeaderGet do
  ...
  describe '#url' do
    ...
    it do
      expect(subject).to eq 'https://api.rms.rakuten.co.jp/es/1.0/navigation/genre/header/get'
    end
  end

  describe '#api_name' do
    subject { object.send(:api_name) }
    it { expect(subject).to eq 'genre header get' }
  end
end
